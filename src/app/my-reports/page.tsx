...
export default function MyReportsPage() {
  ...
  const loadReports = async () => {
    try {
      ...
      // Add driver filter (only show current driver's reports)
      queryParams.append('driver_id', user?.id || '');
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-600">טוען הדוחות שלי...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="space-y-4">
        <Breadcrumbs
          items={[
            ...
            { label: 'הדוחות שלי', isActive: true },
          ]}
        />
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3 space-x-reverse">
            ...
            <div>
              ...
              <p className="text-text-secondary">צפה בדוחות האיסוף ששלחת</p>
            </div>
          </div>
